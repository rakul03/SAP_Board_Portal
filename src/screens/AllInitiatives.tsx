...
export function AllInitiatives({ onOpenDetail, onBack }: AllInitiativesProps) {
  const {
    initiatives,
    owners,
    favorites,
  ...
  }, [initiatives, categoryFilter, ownerFilter, logDateFilter, statusFilter, search]);
  ...
  const hasFilters = Boolean(search || categoryFilter || ownerFilter || logDateFilter || statusFilter);
  ...
  const handleExport = (scope: 'all' | 'view') => {
    const set = scope === 'all' ? initiatives : filtered;
    const fname = `all_initiatives_${todayStamp()}.xlsx`;
  ...
  return (
    <div className={styles.wrap}>
      <PageHeader
        ...
        subtitle="Complete portfolio view across all categories"
        breadcrumbs={['SAP Board Portfolio', 'All Initiatives']}
        actions={
          <>
            {onBack && (
        ...
        <div className={styles.filterBar}>
          <div className={styles.filterTop}>
            ...
            <div className={styles.filterMeta}>
              <span className={styles.filterMetaCount}>{initiatives.length}</span>
              <span className={styles.filterMetaLabel}>total initiatives</span>
            </div>
          </div>
            ...
            <label className={styles.field}>
              ...
              <div className={styles.inputWrap}>
                ...
                >
                  ...
                  <option value="Product Replacements">Product Replacements</option>
          ...
          <div className={styles.list}>
            {filtered.length === 0 ? (
              <div className={styles.emptyState}>
                ...
                <p>Check filters or create a new initiative.</p>
              </div>
            ) : (
